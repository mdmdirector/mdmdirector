...
func main() {
	...
	flag.IntVar(&OnceIn, "once-in", env.Int("once-in", 60), "Number of minutes to wait before queuing an additional command for an individual device. Ignored and overidden as 2 (minutes) if --debug is passed.")
	flag.Parse()
